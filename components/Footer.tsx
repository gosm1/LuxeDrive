...
const Footer = () => {
    return (
        <footer className="w-full  bg-cardblack">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                <a href="" className="flex justify-center h-[250px]">
                    <Image src={logo} alt="footer logo"  className='object-contain'
                    
                    /> 
                </a>
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 pb-16 mb-10 border-b border-gray-200">
                        <li><a className="text-white hover:text-gray-400 focus:outline-none focus:text-gray-400" href="/" aria-current="page">Home</a></li>
                        <li><a className="text-white hover:text-gray-400 focus:outline-none focus:text-gray-400" href="#About-Us">About Us</a></li>
                        <li><a className="text-white hover:text-gray-400 focus:outline-none focus:text-gray-400" href="/cars">Cars</a></li>
                        <li><a className="text-white hover:text-gray-400 focus:outline-none focus:text-gray-400" href="#categories">Categories</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="#" className="block  text-greeyellow transition-all duration-500 hover:text-greenhover ">
                    ...
                    <span className="text-lg text-gray-500 text-center block">©<a>LuxeDrive</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>           
  )
